...
const Home = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-2 left-[50.75%] 3xl:left-[51.2%] transform -translate-x-1/2 mt-5">
      ...
      <div className="absolute top-[5vh] right-[10vw] mt-10 sm:right-[5vw] sm:top-[10vh]">
      ...
      <div className="flex flex-col md:flex-row items-end justify-center w-full ms-[90px]">
        <div className="flex-1 mb-16 text-white h-full text-center md:text-left">
          <div className="ms-10" style={{ translate: "none", rotate: "none", scale: "none", transform: "translate(0px, 0px)", opacity: 1 }}>
            <div className="text-2xl font-extrabold" style={{ color: "black" }}>
        ...
        <div className="flex-1 h-full object-center">
          <div className="flex-1 h-full object-center"></div>
        </div>
